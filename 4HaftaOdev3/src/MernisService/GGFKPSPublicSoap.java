...
public class GGFKPSPublicSoap
{
    ...
    public GGFKPSPublicSoap(){}

    public GGFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GGFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GGFExtendedSoapSerializationEnvelope envelope= new GGFExtendedSoapSerializationEnvelope(GGFExtendedSoapSerializationEnvelope.VER11);
